...
public class ResultTest {
	...
	/**
	 * @verifies {@link Result#Result(List<QResult;>)}
	 * test = should not fail with null list
	 */
	...
	/**
	 * @verifies {@link Result#Result(List<QResult;>)}
	 * test = should not fail with empty list
	 */
	@SuppressWarnings("unchecked")
    @Test
	...
	/**
	 * @verifies {@link Result#Result(Result)}
	 * test = should not fail with null result
	 */
	@Test
	...
	/**
	 * @verifies {@link Result#earliest()}
	 * test = should get the first result given multiple results
	 */
	@Test
	...
	/**
	 * @verifies {@link Result#earliest()}
	 * test = should get the result given a single result
	 */
	@Test
	...
	/**
	 * @verifies {@link Result#earliest()}
	 * test = should get an empty result given an empty result
	 */
	@Test
	...
	/**
	 * @verifies {@link Result#earliest()}
	 * test = should not get the result with null result date given other results
	 */
	@Test
	...
	/**
	 * @verifies {@link Result#earliest()}
	 * test = should get one result with null result dates for all results
	 */
	@Test
	...
	/**
	 * @verifies {@link Result#equals(Object)}
	 * test = should return true on two empty results
	 */
	@Test
	...
	/**
	 * @verifies {@link Result#get(int)}
	 * test = should get empty result for indexes out of range
	 */
	@Test
	...
	/**
	 * @verifies {@link Result#latest()}
	 * test = should get the most recent result given multiple results
	 */
	@Test
	...
	/**
	 * @verifies {@link Result#latest()}
	 * test = should get the result with null result date
	 */
	@Test
	...
	/**
	 * @verifies {@link Result#toObject()}
	 * test = should fail when contains multiple results
	 */
