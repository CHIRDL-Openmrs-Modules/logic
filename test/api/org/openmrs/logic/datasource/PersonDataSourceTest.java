...
public class PersonDataSourceTest extends BaseModuleContextSensitiveTest {
    ...
    /**
     * @verifies {@link PersonDataSource#read(LogicContext,Cohort,LogicCriteria)}
     * test = should get birthdate
     */
    @Test
	@SkipBaseSetup
    ...
    /**
     * @verifies {@link PersonDataSource#read(LogicContext,Cohort,LogicCriteria)}
     * test = should get birthdate_estimated
     */
    @Test
	@SkipBaseSetup
    ...
    /**
     * @verifies {@link PersonDataSource#read(LogicContext,Cohort,LogicCriteria)}
     * test = should get gender equals value
     */
    @Test
	@SkipBaseSetup
    ...
    /**
     * @verifies {@link PersonDataSource#read(LogicContext,Cohort,LogicCriteria)}
     * test = should get cause_of_death
     */
    @Test
	@SkipBaseSetup
